...
var playerBarPreviousButton= '<span class="ion-skip-backward"></span>';
...
var secondsTens= Math.floor((timeInSeconds%60)/10);
var secondsOnes= Math.floor((timeInSeconds%60)%10);
